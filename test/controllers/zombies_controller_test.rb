...
class ZombiesControllerTest < ActionController::TestCase
  ...
  test 'should create zombie' do
    assert_difference('Zombie.count') do
      post :create, zombie: { graveyard_id: @zombie.graveyard_id, name: @zombie.name, status: @zombie.status }
    end
  ...
  test 'should update zombie' do
    patch :update, id: @zombie, zombie: { graveyard_id: @zombie.graveyard_id, name: @zombie.name, status: @zombie.status }
    assert_redirected_to zombie_path(assigns(:zombie))
  end
